...
names = [
    ...
    "Kaliningrad", "Leningrad", "Novo-Nikolaevsk", "Nizhniy Novgorod", "Chelyabinsk", "Ufa", "Dhaka", "Kathmandu", "Pokhara", "Patan", "biratnagar", "Birgunj", "dharan-bazar"
    ...
    "Nakhon Ratchasima", "Chiangmai", "Hat Yai", "Pak Kret", "si-racha", "Amphoe Phra Pradaeng", "Lampang", "surin", "Vientiane", "Rangoon", "Kota Bharu", "Kuala Lumpur", "klang",
    ...
    "Melbourne", "Brisbane", 'Perth', 'Adelaide', 'Gold', 'Canberra', 'Newcastle', 'Wollongong', 'Logan', 'New York', 'LA', 'Chicago', 'Borough of Brooklyn', 'borough-of-queens',
    ...
    'Basel', 'Bern', 'Lausanne', 'Winterthur', 'St. Gallen', 'Lucerne', 'Prague', 'Brno', 'Ostrava', 'Pilsen', 'Olomouc', 'Liberec', 'Budweis', 'Hradec Králové', 'Rome', 'Milan',
    ...
    'Stavanger', 'Drammen', 'Fredrikstad', 'Kristiansand', 'Sandnes', 'Vienna', 'Graz', 'Linz', 'Salzburg', 'Innsbruck', 'Klagenfurt', 'Villach', 'Wels', 'Nicosia', 'Limassol',
    ...
    'Tampere', 'Vantaa', 'Turku', 'Oulu', 'Lahti', 'Kuopio', 'Jyvaskyla', 'Pori', 'Noumea', 'Stockholm', 'Goteborg', 'Malmo', 'Uppsala', 'Västerås', 'Linköping', 'Helsingborg',
