...
# 'Rustavi', 'Haifa',
# 'Tel Aviv', 'Ariel', 'West Jerusalem', 'Ashdod', 'Rishon LeZion', 'Petach Tikva', 'Beersheba', 'Ankara', 'Istanbul', 'Izmir', 'Bursa', 'Adana', 'Gaziantep',
# 'Konya', 'cankaya', 'Antalya', 'Tehran', 'Mashhad','Isfahan', 'Karaj',
cities = [
'Tabriz', 'Shiraz', 'Qom', 'Ahvaz', 'Dubai', 'al-sohar', 'Saham', 'Manama', 'Al Muharraq',
